var menuList = [
  { "id": '001', "path": "/dashboard", "icon": "iconhome1", "name": "主页" },
  { "id": '002', "path": "/jzbz", "icon": "iconaspjiesuan", "name": "集中报账", "children": [
    { "id": '002001', "path": '/jzbz/expenseAccount', "name": '报销单提交图'},
    { "id": '002002', "path": '/jzbz/sendOrders', "name": '派单图'}
  ]},
  { "id": '003', "path": "/bzgl", "icon": "iconshengyijing", "name": "差旅报销" , "children": [
    { "id": '003001', "path": '/bzgl/zntb', "name": "智能填报"}
  ]},
  {
    "id": '004', "path": '/config', "icon": "icontool-hardware", "name": "系统参数配置", "children": [
      ...
      { "id": '004006', "path": '/config/roleGroup', "name": "角色组" },
      { "id": '004007', "path": '/config/role', "name": "角色" },
      { "id": '004008', "path": '/config/permission', "name": "权限管理" },
      { "id": '004009', "path": '/config/datasource', "name": "数据源" },
      { "id": '004010', "path": '/config/search', "name": "查询定义" },
      { "id": '004011', "path": '/config/group', "name": "组" },
    ]
  },
  {
    "id": '100', "path": '/template', "icon": "iconSimilarproducts-fill", "name": "功能模版", "children": [
